/*
Package kgcrypto - Implementação de curvas elípticas KG256r1 e KG384r1 para criptografia de chave pública, 
...
Este pacote define curvas elípticas personalizadas com parâmetros cuidadosamente escolhidos para garantir maior 
eficiência computacional em operações de ECDSA e ECDH. As curvas KG256r1 e KG384r1 seguem a forma clássica de 
Weierstrass com parâmetros `a`, `b`, `p`, `n`, `Gx`, `Gy`, mas com um coeficiente `a` não trivial, o que permite 
otimizações específicas de curva.
...
A implementação é compatível com as interfaces padrão da biblioteca crypto Go, tornando possível o uso 
transparente em aplicações que esperam `crypto.Signer` ou `crypto.PublicKey`.
